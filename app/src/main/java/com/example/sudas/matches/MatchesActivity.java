...
public class MatchesActivity extends AppCompatActivity {
    ...
    private void getUserMatchId() {
        DatabaseReference matchDb = FirebaseDatabase.getInstance(Globals.DBAddress).getReference().child("users").child(cusrrentUserID).child("connections").child("matches");
